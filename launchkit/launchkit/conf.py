...
launchkit_project_dir = join(os.path.dirname(launchkit.launchkit.__file__), os.pardir)
LOCAL_LOG_DIR = join(launchkit_project_dir, 'data')
...
unless you use AWS, GCP. I recommend
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    join(launchkit_project_dir, 'scripts', 'run_experiment_from_doodad.py')
)
"""
AWS Settings
"""
...
try:
    from launchkit.launchkit.conf_private import *
except ImportError:
